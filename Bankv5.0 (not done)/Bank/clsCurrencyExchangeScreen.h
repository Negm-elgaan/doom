...
private:
    ...
    static void _PerformLoanMenueOption(enCurrencyExchangeMenueOption CurrencyExchangeMenueOption)
    {
...
public:
    ...
    static void ShowCurrencyExchangeMenue()
    {
        ...
        _PerformLoanMenueOption((enCurrencyExchangeMenueOption)ReadCurrencyExchangeMenueOption());
    }
